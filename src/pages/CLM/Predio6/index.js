...
export default class Report extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await api.get(`/report/${actualReport}-predio6`);
  ...
  async handleForm() {
    const insertEnvironment = await api.post('/environment', {
      reportid: `${this.state.actualReport}-predio6`,
    ...
    const loginpath = `/report-mensal/environment/clm/predio7/${this.state.actualReport}`;
        ...
        <>
          <Page>
            ...
            <Container>
              ...
              <Divider />
              <Form>
                <ReportTitle>Report Ambiental - Prédio 6 CLM</ReportTitle>
                <Row>
                  <FormGroup>
