...
export default class Report extends Component {
  ...
  async componentDidMount() {
    ...
    const response = await api.get(`/report/${actualReport}-predio5`);
  ...
  async handleForm() {
    const insertEnvironment = await api.post('/environment', {
      reportid: `${this.state.actualReport}-predio5`,
    ...
    const loginpath = `/report-mensal/environment/clm/predio6/${this.state.actualReport}`;
        ...
        <>
          <Page>
            ...
            <Container>
              ...
              <Divider />
              <Form>
                <ReportTitle>Report Ambiental - Prédio 5 CLM</ReportTitle>
                <Row>
                  <FormGroup>
